    ...
    return (
      <div className="flex items-center gap-2">
        <div className="flex flex-col">
          ...
          {currentOwnerName && (
            <span className="text-xs text-muted-foreground">{t('boardSwitcher.from', { name: currentOwnerName })}</span>
          )}
        </div>
            ...
            {sharedBoards.map((b) => {
              ...
              return (
                ...
                >
                  ...
                  {ownerName && (
                    <span className="text-xs text-muted-foreground">{t('boardSwitcher.from', { name: ownerName })}</span>
                  )}
                </DropdownMenuItem>
              )
            })}
